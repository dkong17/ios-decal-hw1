...
//: No because one is an implicitly unwrapped optional, and the other is not.
...
//: The variable i is declared constant by use of let. Method should be class method, and needs unconditional return at the end.
...
//: The original dictionary syntax is that of declaring a dictionary with a literal; later reference causes
//: errors as it tries to reference a nonexistant dictionary. The method should be an instance method.
